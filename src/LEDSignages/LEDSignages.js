...
import './LEDSignages.css';


class LEDSignages extends Component { 
    render() {
        ...
        return (
            ...
            <div className="led-signages-container">
                <img src="https://radhahitech.com/wp-content/uploads/2025/02/led-sign-board-1.jpg" 
                alt="led-signages" className='led-signages-image' />
                 <SocialMedia title="LED Signages" />

                <div className='led-signages-section'>
                <h1 className='led-signages-heading'>Illuminate Your Brand with Impact</h1>
                <p className='led-signages-paragraph'> At Radha Hi-Tech Print Solutions, we specialize in 
                    ...
                    <h1 className='led-signages-heading'>Our LED Signage Solutions</h1>
                <h3 className='led-signages-sub-heading'>LED Sign Boards</h3>
                <p className='led-signages-paragraph'> Bright, vibrant, and customized to suit your
